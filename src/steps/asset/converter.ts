  ...
  return createIntegrationEntity({
    entityData: {
      ...
      assign: {
        ...
        name: name,
        createdAt: parseTimePropertyValue(asset.created_at, 'sec'),
        updatedAt: parseTimePropertyValue(asset.updated_at, 'sec'),
        alive: asset.alive,
        lastSeen: parseTimePropertyValue(asset.last_seen, 'sec'),
        lastSeenOn: parseTimePropertyValue(asset.last_seen, 'sec'),
        firstSeen: parseTimePropertyValue(asset.first_seen, 'sec'),
